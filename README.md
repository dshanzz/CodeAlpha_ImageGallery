# 🖼️ Image Gallery - CodeAlpha Task 1
...
| Search Functionality | Real-time search with debounce (300ms)     |
| Image Statistics     | Total/visible counts, active category      |
| Keyboard Navigation  | ← → ESC keys in lightbox                   |
| Lazy Loading         | `loading="lazy"` on all images             |
| Error Handling       | Fallback placeholder image on load failure |
...
| CSS3            | Styling   | Grid, Flexbox, animations, CSS variables      |
| JavaScript ES6+ | Logic     | Filtering, lightbox, event handling, debounce |
| Bootstrap 5     | Layout    | Responsive utilities, spacing                 |
| Font Awesome 6  | Icons     | Navigation, UI elements                       |

## 📱 Responsive Breakpoints

| Device                | Columns   | Grid Gap | Header Font Size |
| --------------------- | --------- | -------- | ---------------- |
| Desktop (>992px)      | 4 columns | 25px     | 3rem             |
...
| ----------------------- | ------------ | ---------- |
| Mountain Landscape      | Nature       | 1920×1080  |
| Modern Cityscape        | Architecture | 1920×1280  |
| Abstract Art            | Abstract     | 1350×900   |
| Tech Devices            | Technology   | 1920×1280  |
| Forest Path             | Nature       | 1920×1280  |
| Futuristic Architecture | Architecture | 1350×900   |
| Digital Art             | Abstract     | 1350×900   |
| Programming Code        | Technology   | 1920×1080  |
| Ocean Waves             | Nature       | 1920×1280  |
| Historical Building     | Architecture | 1350×900   |
| Color Splash            | Abstract     | 1350×900   |
| Circuit Board           | Technology   | 1920×1080  |
...
- **Category Filter**: Click any category button (Nature, Technology, Architecture, Abstract) to show only images from that category. Click "All" to reset.
- **Search Filter**: Start typing in the search box to filter images by title, category, or description in real-time. Try "mountain" or "abstract".

### ⌨️ Keyboard Shortcuts (when lightbox is open)
...
[Add your LinkedIn video post link here after recording.]

## 📝 Credits

- Code adapted from a fellow intern's submission.
